<%-- 
    ...
    Created on : 24 Feb, 2020, 4:30:18 PM
    Author     : Parthik Shah
--%>
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                <div class="nav-user-info">
                                    <h5 align="center" class="mb-0 text-white nav-user-name"><%=name %> </h5>
                                    <!--<span class="status"></span><span class="ml-2">Available</span>-->
                                </div>
                                <!--<a class="dropdown-item" class="nav-link" id="pills-msg-tab" data-toggle="pill" href="#pills-msg"><i class="fas fa-user mr-2"></i>Account</a>-->
                        ...
                        <div class="col-xl-9 col-lg-9 col-md-7 col-sm-12 col-12">
                            ...
                            <div class="influence-profile-content pills-regular">
                                <ul class="nav nav-pills mb-3 nav-justified" id="pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="pills-packages-tab" data-toggle="pill" href="#pills-packages" role="tab" aria-controls="pills-packages" aria-selected="false">Prescription</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <div class="card mb-2">
                                        <div class="card-header" id="headingNine">
												...
												<button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseNine" aria-expanded="false" aria-controls="collapseNine">
													  <span class="fas mr-3 fa-angle-down"></span>Download Prescription
																 </button>
																		   </h5>
                                        </div>
